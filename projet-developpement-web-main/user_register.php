...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() > 0){
      ...
      if($pass != $cpass){
         $message[] = 'Confirmation du mot de passe ne correspond pas !';
      }else{
...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Créez votre compte maintenant</h3>
      <input type="text" name="name" required placeholder="entrer votre nom d'utilisateur" maxlength="20"  class="box">
