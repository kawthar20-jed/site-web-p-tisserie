...
<div class="box-container">
   ...
   ?>
   <div class="box">
      <p> Passée le : <span><?= $fetch_orders['placed_on']; ?></span> </p>
      <p> nom : <span><?= $fetch_orders['name']; ?></span> </p>
      <p> numéro : <span><?= $fetch_orders['number']; ?></span> </p>
      <p> addresse : <span><?= $fetch_orders['address']; ?></span> </p>
      <p> Nombre total de produits : <span><?= $fetch_orders['total_products']; ?></span> </p>
      <p> Prix total : <span>MAD<?= $fetch_orders['total_price']; ?>/-</span> </p>
      <p> Moyen de paiement : <span><?= $fetch_orders['method']; ?></span> </p>
      <form action="" method="post">
        ...
        <div class="flex-btn">
         <input type="submit" value="mettre a jour" class="option-btn" name="update_payment">
