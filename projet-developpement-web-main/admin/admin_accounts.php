...
<section class="accounts">
   ...
   <div class="box">
      ...
      <a href="register_admin.php" class="option-btn">Inscrire un administrateur</a>
   </div>
   ...
   ?>
   <div class="box">
      <p> id d'administrateur: <span><?= $fetch_accounts['id']; ?></span> </p>
      <p>  nom d'admistrateur : <span><?= $fetch_accounts['name']; ?></span> </p>
      <div class="flex-btn">
         ...
         <?php
            if($fetch_accounts['id'] == $admin_id){
               echo '<a href="update_profile.php" class="option-btn">mettre a jour</a>';
            }
         ?>
      </div>
   </div>
