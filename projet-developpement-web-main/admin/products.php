   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         <div class="inputBox">
            ...
            <input type="text" class="box" required maxlength="100" placeholder="entrer le nom du produit" name="name">
         </div>
         <div class="inputBox">
            <span>prix du produit (obligatoire)</span>
            <input type="number" min="0" class="box" required max="9999999999" placeholder="entrer prix du produit" onkeypress="if(this.value.length == 10) return false;" name="price">
         </div>
        <div class="inputBox">
        ...
        <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <textarea name="details" placeholder="entrer Détails du produit" class="box" required maxlength="500" cols="30" rows="10"></textarea>
         </div>
      </div>
      
      <input type="submit" value="ajouter produit" class="btn" name="add_product">
   </form>
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="price">MAD<span><?= $fetch_products['price']; ?></span>/-</div>
      <div class="details"><span><?= $fetch_products['details']; ?></span></div>
      <div class="flex-btn">
         <a href="update_product.php?update=<?= $fetch_products['id']; ?>" class="option-btn">Mettre a jour</a>
